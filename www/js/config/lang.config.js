...
function config ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'LOGIN_TITLE': 'Welcome To the '+_Config.contact.name+' app.',
    'LOGIN_TEXT': 'Sign In',
    ...
    'USER_LOGIN_BUTTON': 'Existing User',
    'PASSWORD_RESET_BUTTON': 'Password Lost',
    'PASSWORD_RESET_TITLE': 'Password Lost ?',
    'PASSWORD_RESET_TEXT': 'Please give us your email address, a password recovery email will be sent to you',
    ...
    'ACCOUNT_FRIENDS_DATA':'My friends',
    ...
    'REGISTER_TEXT': "Please provide your email address and a password",
    'REGISTER' : 'Sign Up',
  ...
  $translateProvider.translations('fr', {
    ...
    'LOGIN_TITLE': 'Bienvenue sur l\'appli '+_Config.contact.name+'.',
    ...
    'TWITTER_SIGNIN': 'Twitter',
    'GOOGLE_SIGNIN': 'Google',
    'USER_LOGIN': 'Utilisteur Enregistré',
    'PASSWORD_RESET_BUTTON': 'Mot de Passe Perdu',
    'PASSWORD_RESET_TITLE': 'Mot de Passe Perdu ?',
    'PASSWORD_RESET_TEXT': 'Entrez votre adresse email ci dessous un email de réinitialisation de mot de passe vous sera envoyé',
    ...
    'REGISTER_TEXT': "Merci d'indiquer votre adresse email et un mot de passe",
