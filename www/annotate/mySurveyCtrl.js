...
.controller('mySurveyCtrl', ["$scope", "$rootScope", "myPrivacySettingsData", "$firebaseArray", "FirebaseConfig", "$ionicScrollDelegate", function($scope, $rootScope, myPrivacySettingsData, $firebaseArray, FirebaseConfig, $ionicScrollDelegate) {
